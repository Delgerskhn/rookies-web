...
export const LayoutGrid = ({ cards }: { cards: Card[] }) => {
  ...
  return (
    <div className="mx-auto grid h-full w-full max-w-5xl grid-cols-1  gap-4 p-10 md:grid-cols-3 ">
      {cards.map((card, i) => (
      ...
      {/* <motion.div
        ...
        className={cn(
          'fixed inset-0 z-10 h-full w-full bg-black opacity-0',
  ...
  return (
    <div className="relative z-[60] flex h-full w-full flex-col justify-end rounded-lg bg-transparent shadow-2xl">
      <motion.div
        ...
        className=" inset-0 z-10 h-full w-full bg-black opacity-60"
      />
      <motion.div
        initial={{
          opacity: 0,
