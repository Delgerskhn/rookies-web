            ...
            >
              <div className="card relative flex w-full max-w-sm flex-col justify-between text-center">
                ...
                <ul className="px-2 py-0">
                  ...
                  <li className="mb-2.5 mt-5 flex items-center justify-center text-center font-semibold">
                  ...
                  {texts &&
                    texts.map((item, index) => (
                      ...
                      >
                        <div className="mr-1.5 mt-1.5 flex h-4 w-4 items-center justify-center rounded-full border-2 border-primary-600 bg-primary-600">
